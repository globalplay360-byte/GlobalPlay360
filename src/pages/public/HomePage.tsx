      ...
      <section className="relative w-full h-[100vh] flex flex-col justify-center items-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center max-w-4xl px-4 flex flex-col items-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/register?type=jugador" className="flex items-center justify-center gap-2 bg-[#0070F3] hover:bg-[#0051B3] text-white px-7 py-3.5 rounded-md font-medium transition-all duration-fast ease-out active:scale-[0.98] w-full sm:w-auto text-sm">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
              {t('homePage.hero.btnPlayer')}
            </Link>
            <Link to="/register?type=entrenador" className="flex items-center justify-center gap-2 border border-white/20 hover:border-white/50 hover:bg-white/5 px-7 py-3.5 rounded-md font-medium transition-all duration-fast ease-out active:scale-[0.98] w-full sm:w-auto text-sm">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              {t('homePage.hero.btnCoach')}
            </Link>
            <Link to="/register?type=club" className="flex items-center justify-center gap-2 border border-white/20 hover:border-white/50 hover:bg-white/5 px-7 py-3.5 rounded-md font-medium transition-all duration-fast ease-out active:scale-[0.98] w-full sm:w-auto text-sm">
      ...
      <section className="py-24 px-4 bg-[#0A192F]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#020C1B] rounded-xl p-8 border border-white/10 relative overflow-hidden group hover:border-[#0070F3] hover:-translate-y-0.5 transition-all duration-base ease-out">
      ...
      <section className="py-24 px-4 bg-[#020C1B]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
            ...
            {/* Free Plan */}
            <div className="bg-[#0A192F] rounded-2xl p-8 border border-white/10 shadow-xl flex flex-col hover:-translate-y-0.5 transition-transform duration-base ease-out">
              <div className="mb-6">
              ...
              <Link to="/register" className="block w-full py-3 px-4 text-center rounded-lg border border-white/20 text-white hover:bg-white/5 font-semibold transition-all duration-fast ease-out active:scale-[0.98]">
            ...
            <div className="bg-gradient-to-b from-[#112240] to-[#0A192F] rounded-2xl p-8 border-2 border-[#0070F3] shadow-[0_0_30px_rgba(0,112,243,0.15)] relative flex flex-col">
              ...
              <Link to="/pricing" className="block w-full py-3 px-4 text-center rounded-lg bg-[#0070F3] text-white hover:bg-[#0051B3] font-semibold transition-all duration-fast ease-out active:scale-[0.98] shadow-lg">
      ...
      <section className="py-20 px-4 bg-[#0A192F] border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="#" className="w-12 h-12 rounded-full bg-[#020C1B] border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-[#0070F3] hover:-translate-y-0.5 transition-all duration-fast ease-out">
              {/* Fake X / Twitter icon */}
