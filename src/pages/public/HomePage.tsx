    ...
    <div className="flex flex-col w-full bg-[#0B1120] text-white">
      ...
      <section className="relative w-full h-[100vh] flex flex-col justify-center items-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center max-w-5xl px-4 flex flex-col items-center">
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-medium mb-6 leading-tight tracking-tighter text-white whitespace-nowrap drop-shadow-xl">
            {titleParts[0]}
            {titleParts[1] && (
      ...
      <section className="py-24 px-4 bg-[#0B1120]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-medium text-white/90 max-w-2xl mx-auto tracking-normal leading-relaxed">
      ...
      <section className="py-20 px-4 bg-[#0F172A] border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
            {/* YouTube */}
            <a href="https://www.youtube.com/@GlobalPlay_360" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#111827] border border-white/5 flex items-center justify-center text-[#9CA3AF] hover:text-[#FF0000] hover:border-[#FF0000] hover:-translate-y-1 transition-all duration-300 ease-out" aria-label="YouTube">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/people/GlobalPlay360/61585220529973/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#111827] border border-white/5 flex items-center justify-center text-[#9CA3AF] hover:text-[#1877F2] hover:border-[#1877F2] hover:-translate-y-1 transition-all duration-300 ease-out" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>

            {/* X / Twitter */}
            <a href="https://x.com/globalplay_360" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-[#111827] border border-white/5 flex items-center justify-center text-[#9CA3AF] hover:text-white hover:border-white hover:-translate-y-1 transition-all duration-300 ease-out" aria-label="X (Twitter)">
