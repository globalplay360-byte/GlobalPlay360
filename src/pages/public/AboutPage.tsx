...
function ArchitectureSection() {
  ...
  const pillars = [
    ...
    },
    {
      ...
      desc: t('aboutPage.arch.gdpr.desc', 'Data hosted in europe-west1. Restrictive security rules on every collection. Self-service data export and account deletion built in.'),
