  ...
  return (
    <div className="relative min-h-screen text-gray-100 overflow-hidden bg-[#0B1120]">
      ...
      <div className="absolute inset-0 z-0 select-none pointer-events-none">
        ...
        >
          <source src="https://firebasestorage.googleapis.com/v0/b/globalplay360-3f9a1.firebasestorage.app/o/global_home.mp4?alt=media&token=d56dab23-e1be-4f3a-a9b6-bd7faeba7b4b" type="video/mp4" />
        </video>
