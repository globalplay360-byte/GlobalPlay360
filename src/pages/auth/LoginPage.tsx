...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0B1120] p-4 font-sans text-[#FFFFFF]">
      <div className="w-full max-w-md bg-[#111827] rounded-xl border border-[#1F2937] shadow-xl p-8 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#9CA3AF] text-sm">Entra en tu cuenta de Global Play 360</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="block text-sm font-medium text-[#9CA3AF]" htmlFor="password">Contraseña</label>
              <Link to="/forgot-password" className="text-xs text-[#3B82F6] hover:text-[#2563EB] transition-colors">¿La has olvidado?</Link>
            </div>
            <input 
              id="password"
              type="password" 
        ...
        <div className="mt-8 relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#111827] px-4 text-[#9CA3AF]">O continúa con</span>
          </div>
        </div>
