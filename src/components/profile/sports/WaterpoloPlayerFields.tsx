...
const POSITIONS = ['Porter', 'Defensa', 'Boia', 'Extrem', 'Central'];
  ...
  return (
    <section className="bg-[#111827] border border-[#1F2937] rounded-xl p-5 sm:p-7 flex flex-col gap-5 sm:gap-6 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="text-lg sm:text-xl font-extrabold text-gray-100 tracking-tight">{t('sports.details', 'Detalls de Waterpolo')}</h2>
      </div>
