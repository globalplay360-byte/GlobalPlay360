    ...
    <header className="h-16 bg-[#0B1120] border-b border-[#1F2937] flex items-center justify-between px-6 z-10 sticky top-0">
      ...
      <div className="hidden md:flex flex-1 max-w-md ml-4 lg:ml-0 relative">
        ...
        <input 
          ...
          className="w-full bg-[#0F172A] text-white border border-[#1F2937] rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:border-[#3B82F6] transition-colors"
        />
      </div>
