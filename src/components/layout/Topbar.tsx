  ...
  return (
    <header className="h-16 bg-[#0B1120] border-b border-[#1F2937] flex items-center justify-between px-6 z-10 sticky top-0">
      ...
      <div className="flex lg:hidden items-center">
        <button className="text-[#9CA3AF] hover:text-gray-100 p-2 transition-colors duration-fast ease-out">
      ...
      <div className="flex items-center gap-4">
        {/* Notificacions */}
        <button className="text-[#9CA3AF] hover:text-gray-100 transition-colors duration-fast ease-out relative">
