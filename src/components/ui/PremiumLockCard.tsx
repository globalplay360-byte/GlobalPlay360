...
export default function PremiumLockCard({
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-8 bg-[#111827] border border-[#1F2937] rounded-xl text-center shadow-lg relative overflow-hidden group ${className}`}>
      ...
      <div className="w-16 h-16 bg-gradient-to-br from-[#3B82F6] to-[#2563EB] text-gray-100 rounded-[1.25rem] flex items-center justify-center mb-5 shadow-[0_0_20px_rgba(59,130,246,0.35)] z-10 transform group-hover:scale-105 transition-transform duration-base">
      ...
      <h3 className="text-xl sm:text-2xl font-medium text-gray-100/90 tracking-normal mb-3 z-10">{finalTitle}</h3>
      <p className="text-sm text-[#9CA3AF] mb-6 max-w-md z-10 leading-relaxed">{finalDescription}</p>
      
      <Link
        to="/pricing"
        className="z-10 inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-gray-100 hover:from-[#2563EB] hover:to-[#1D4ED8] text-sm font-bold tracking-wide rounded-lg transition-all duration-base active:scale-[0.98] shadow-md hover:shadow-lg hover:shadow-[#3B82F6]/30"
      >
